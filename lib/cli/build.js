...
var argv = require('yargs').usage('Usage: bees build [options]').option('debug', {
  type: 'boolean',
...
function build(argv) {
  ...
  if (!rcConfig.use) {
    console.log(_chalk2.default.red('\u4F60\u6CA1\u6709\u5728' + _chalk2.default.yellow('.beesrc') + '\u4E2D\u5B9A\u4E49' + _chalk2.default.cyan('use') + '.'));
    process.exit(1);
  }
  ...
  return new _promise2.default(function (resolve) {
    ...
    (0, _recursiveReaddir2.default)(appBuild, function (errors, fileNames) {
...
function getDifferenceLabel(currentSize, previousSize) {
  ...
  var fileSize = !(0, _isNan2.default)(difference) ? (0, _filesize2.default)(difference) : 0;
