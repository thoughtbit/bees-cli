...
exports.default = function (args, appBuild, config, paths) {
  ...
  var webpackConfig = (0, _webpackMerge2.default)(commonConfig, {
    ...
    new _webpack2.default.IgnorePlugin(/^\.\/locale$/, /moment$/)].concat(!config.sw ? [] : new _webpackManifestPlugin2.default({
      fileName: 'asset-manifest.json'
    })).concat(!config.sw ? [] : new _swPrecacheWebpackPlugin2.default({
