...
exports.default = function (config, cwd) {
  ...
  var _config$library = config.library,
      ...
      devtool = _config$devtool === undefined ? _webpackConfig.defaultDevtool : _config$devtool;
  ...
  var webpackConfig = (0, _webpackMerge2.default)(commonConfig, {
    ...
    new _WatchMissingNodeModulesPlugin2.default(paths.appNodeModules)].concat(dllPlugins, (0, _toConsumableArray3.default)((0, _webpackConfig.getCommonPlugins)({
      config: config,
      paths: paths,
